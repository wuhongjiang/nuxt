...
@wuhongjiang 
1
2 1 itcast-hsian/xianyun-34
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Security  Insights
xianyun-34/components/air/searchForm.vue
@itcast-hsian itcast-hsian 整理
4f35c63 10 hours ago
344 lines (292 sloc)  8.66 KB
...
<div class="search-form">
  ...
  <el-form class="search-form-content" ref="form" label-width="80px">
    ...
    <el-form-item label="到达城市">
      <el-autocomplete :fetch-suggestions="queryDestSearch" placeholder="请搜索到达城市" @select="handleDestSelect" class="el-autocomplete" v-model="form.destCity"></el-autocomplete>
    </el-form-item>
